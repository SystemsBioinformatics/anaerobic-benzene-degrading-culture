...
# data locations
datadir <- '/media/chrats/Elements/00_FINAL_2020/Benzene/succession_experiment/Data'
...
print(prowf)
# ggsave("/home/chrats/Desktop/bioreactor/all_carbon.pdf",prowf, units="in", width=14, height=15, dpi=300)
```
...
# ggsave("/home/chrats/Desktop/bioreactor/nitrite_rates.pdf",ng, units="in", width=14, height=5, dpi=300)
```
...
print(prowf)
# ggsave("/home/chrats/Desktop/bioreactor/succesion_exp_F_v2.pdf",prowf, units="in", width=14, height=10, dpi=300)
...
p <- ggplot(vartable, aes(x=sampleclass, y=cells)) +geom_boxplot(outlier.shape = NA)+
  ...
  facet_wrap(.~OTU, scales='free')+labs(x="culture stage",y="cells per mL")+ scale_y_continuous(trans = 'sqrt')+  theme(text = element_text(size=size_all),
...
pep<-ggplot(data_dist, aes(x=sampleClass, y=ratio)) +geom_boxplot(outlier.shape = NA)+
  ...
  scale_y_continuous(trans = 'sqrt')+  theme(text = element_text(size=size_all),
plot.title = element_text(size=size_all),
axis.title.x = element_text(size=size_all),
axis.title.y = element_text( size=size_all), 
legend.title = element_text(size=size_all),
...
print(prow)
# ggsave("/home/chrats/Desktop/bioreactor/community_OTUs_19_may.pdf",prow, units="in", width=12, height=10, dpi=300)
...
# ggsave("/home/chrats/Desktop/bioreactor/OTUs_rest_supp.pdf",temp, units="in", width=12, height=10, dpi=300)
```
